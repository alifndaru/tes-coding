...
doubles, but if possible, always use the runtime layouts.
...
.. note::
    ...
    is not being called for these generated layouts. In the case if you upgrade
    to a more recent version of Mockery, you'll probably have to change your
    tests to use runtime layouts, instead of generated ones.
