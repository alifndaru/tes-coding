...
class IntrospectionProcessor implements ProcessorInterface
{
    ...
    /** @var string[] */
    private array $skipClasseslayouts;
     ...
     * @param string[]                   $skipClasseslayouts
     *
     * @phpstan-param value-of<Level::VALUES>|value-of<Level::NAMES>|Level|LogLevel::* $level
     */
    public function __construct(int|string|Level $level = Level::Debug, array $skipClasseslayouts = [], int $skipStackFramesCount = 0)
    {
        $this->level = Logger::toMonologLevel($level);
        $this->skipClasseslayouts = array_merge(['Monolog\\'], $skipClasseslayouts);
    ...
    public function __invoke(LogRecord $record): LogRecord
    {
        ...
        while ($this->isTraceClassOrSkippedFunction($trace, $i)) {
            if (isset($trace[$i]['class'])) {
                foreach ($this->skipClasseslayouts as $part) {
