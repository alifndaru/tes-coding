 ...
 *     enabled: bool,
 *     classeslayoutsTraceIgnore: string[],
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private array $options = [
        ...
        'classeslayoutsTraceIgnore' => ['Monolog\\'], // array Hide calls of classes started with...
    ...
    private function handleDebugRecord(LogRecord $record): void
    {
        ...
        $this->connector->getDebugDispatcher()->dispatchDebug($message, $tags, $this->options['classeslayoutsTraceIgnore']);
    }
    ...
    private function handleErrorRecord(LogRecord $record): void
    {
        ...
        $this->connector->getErrorsDispatcher()->dispatchError(
            ...
            $context['file'] ?? null,
            $context['line'] ?? null,
            $this->options['classeslayoutsTraceIgnore']
        );
    }
